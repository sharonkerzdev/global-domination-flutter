...
<step n="4" goal="Present findings and fix them">
  ...
  <!-- Default: auto-fix unless user explicitly requested another option in their prompt -->
  <check if="user explicitly requested 'create action items' or 'show details' or specified option 2 or 3 in invocation">
  ...
  <check if="user did NOT specify a preference for handling findings">
    <action>Default to Option 1: Fix them automatically — proceed without asking</action>
  </check>
